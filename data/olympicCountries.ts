...
export interface CountryData {
  ...
  colors: string[];
  totalMedals: number;
  recentMedals: number; // Avg of last 3 games
...
export const WINTER_OLYMPICS_COUNTRIES: CountryData[] = [
  ...
  },
  {
    ...
    totalMedals: 438, // Combined GER/GDR/FRG
    recentMedals: 29,
    projectedGold: 14,
  ...
  },
  {
    ...
    totalMedals: 0, // Fresh start under AIN designation
    recentMedals: 6, // Reference from Paris 2024
    projectedGold: 3,
  ...
  },
  {
    code: "AUS",
    name: "Australia",
    colors: ["#FFCD00", "#00843D"], // Gold, Green
    totalMedals: 19,
    recentMedals: 3,
    projectedGold: 1,
